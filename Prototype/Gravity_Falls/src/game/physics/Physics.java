...
public class Physics {
    ...
    public void handlePhysics(Level level, int delta, Gravity gravity){
        ...
        handleLevelObjects(level,delta,gravity);
    }
    ...
    private void handleCharacters(Level level, int delta, Gravity gravity){
        for(Character c : level.getCharacters()){
            ...
            if(!c.isMoving()){
                c.decelerate(delta,gravity);
            }
            
            handleGameObject(c,level,delta,gravity);
    ...
    private void handleLevelObjects(Level level, int delta, Gravity gravity){
        for(LevelObject obj : level.getLevelObjects()){
            
            //just decelerate objects in general
            obj.decelerate(delta,gravity);
            
            handleGameObject(obj,level,delta,gravity);
        }
    }
